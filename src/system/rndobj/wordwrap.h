...
/** "Checks to see if the provided character is considered an East Asian / CJK unicode character." */
bool IsEastAsianChar(wchar_t character);

/** "Determines if a line break is allowed between two characters. Follows kinsoku line breaking rules for CJK unicode text." */
